...
namespace prep.specs
{
    ...
    public class MovieLibrarySpecs
    {
        ...
        public class when_searching_for_movies : concern_for_searching_and_sorting
        {
            ...
            {
                var range = Range.start_from(2004);
            ...
            {
                var range = Range.start_from(1982).inclusive.ends_at(2003).inclusive;
        ...
        public class when_sorting_movies : concern_for_searching_and_sorting
        {
            ...
            {
                var comparison = Sort<Movie>.by(x => x.title);
            ...
            {
                var comparison = Sort<Movie>.by(x => x.date_published, SortOrders.@descending);
            ...
            {
                var comparison = Sort<Movie>.by(x => x.date_published);
            ...
            {
                var comparison = Sort<Movie>.by(x => x.production_studio, ProductionStudio.MGM, ProductionStudio.Pixar,
                    ProductionStudio.Dreamworks,
                    ProductionStudio.Universal, ProductionStudio.Disney).then_by(x => x.date_published);
