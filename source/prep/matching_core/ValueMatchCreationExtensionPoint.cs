...
{
  public class ValueMatchCreationExtensionPoint<Value> :
    IProvideAccessToMatchCreationExtensions<Value, Value, IMatchA<Value>>
  {
    ...
    class NegatingValueMatchCreationExtensionPoint :
      IProvideAccessToMatchCreationExtensions<Value, Value, IMatchA<Value>>
    {
      IProvideAccessToMatchCreationExtensions<Value, Value, IMatchA<Value>> original;

      public NegatingValueMatchCreationExtensionPoint(
        IProvideAccessToMatchCreationExtensions<Value, Value, IMatchA<Value>> original)
      {
